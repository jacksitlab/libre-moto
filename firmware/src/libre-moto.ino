 ...
 * touch controller and I/O expander.
 *--------------------------------------------------------------*/

#define I2C_SDA_PIN 38
#define I2C_SCL_PIN 39
// Provides reset, power, interrupt.
 ...
 *  and local PWM outputs in dependency order.
 *--------------------------------------------------------------*/
 ...
 * registers input and arc callbacks
 *
 * @param none.
 * @return void.
 ...
 *
 * lets LVGL process touch, drawing, animations, and widget events.
 *
 * @param none.
 * @return void.
 ...
 * @return void.
 * @note Called by LVGL after touch changes the volume arc.
 */
void volumeArcEventCb(lv_event_t *e) {
 ...
 * @return void.
 * @note Called by LVGL after touch changes the temperature arc.
 */
void tempArcEventCb(lv_event_t *e) {
  if (lv_event_get_code(e) != LV_EVENT_VALUE_CHANGED) return;
  lv_obj_t *arc = (lv_obj_t *)lv_event_get_target(e);
 ...
 * @return void.
 * @note Called by LVGL after touch changes the brightness arc.
 */
void lightArcEventCb(lv_event_t *e) {
  if (lv_event_get_code(e) != LV_EVENT_VALUE_CHANGED) return;
